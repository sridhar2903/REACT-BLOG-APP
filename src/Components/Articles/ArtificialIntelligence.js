  ...
  return (
    <>
      ...
      <div className='articlebody'>
        <h2 className='main-article-title'>ARTIFICIAL INTELLIGENCE</h2>

        <div className="image-article-section">

          <img src="https://itchronicles.com/wp-content/uploads/2020/11/where-is-ai-used.jpg" className='imgarticle' alt='notfound' />,
        </div>
        ...
        <div className='apply-sticky ' >
          <img src={likes} className='img-sticky-likes' alt='not found' /> <span className='sticky-likes' style={{ fontFamily: 'Montserrat, sans-serif' }}>6k</span>
          <br />
          <br />
