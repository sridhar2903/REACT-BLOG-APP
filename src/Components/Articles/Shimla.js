  ...
  return (
    <>
      ...
      <div className='articlebody'>
        <h2 className='main-article-title'>Shimla</h2>
        ...
        <div className='apply-sticky ' >
          <img src={likes} className='img-sticky-likes' alt='not found' /> <span className='sticky-likes' style={{ fontFamily: 'Montserrat, sans-serif' }}>25k</span>
          <br />
          <br />
