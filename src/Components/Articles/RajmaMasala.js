  ...
  return (
    <>
      ...
      <div className='articlebody'>
        <h2 className='main-article-title'>RAJMA MASALA</h2>

        <div className="image-article-section">

          <img src="https://www.indianhealthyrecipes.com/wp-content/uploads/2019/06/rajma-recipe.jpg" className='imgarticle' alt='notfound' />,
        </div>
        ...
        <div className='apply-sticky ' >
          <img src={likes} className='img-sticky-likes' alt='not found' /> <span className='sticky-likes' style={{ fontFamily: 'Montserrat, sans-serif' }}>70k</span>
          <br />
          <br />
